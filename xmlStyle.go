...
func (alignment *xlsxAlignment) Marshal() (result string, err error) {
	if alignment.Horizontal == "" && alignment.Vertical != "" {
		result = fmt.Sprintf(`<alignment vertical="%s" />`, alignment.Vertical)
	} else if alignment.Vertical == "" && alignment.Horizontal != "" {
		result = fmt.Sprintf(`<alignment horizontal="%s" />`, alignment.Horizontal)
	} else if alignment.Vertical == "" && alignment.Horizontal == "" {
		result = ""
	} else {
		result = fmt.Sprintf(`<alignment horizontal="%s"  vertical="%s" />`, alignment.Horizontal, alignment.Vertical)
	}
